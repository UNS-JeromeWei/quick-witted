...
if not report_directory:
    ...
    text = f'Conclusion report of the simulation of the reflector system.'
    ...
    c.setFont("Helvetica", 13)
    text = '- Optical Path Volume of The System :  [ 111mm × 71mm × 22mm ]'
    ...
    c.setFont("Helvetica", 13)
    text = '- Adjustment of the structural parameters of the mirrors '
    ...
    text = '- The performance of TX light path is good enough no additional calibration system required'
    ...
    text = '- Introduction of a tri-prism element as a horizontally oriented scanning device '
    c.drawString(50, N - 17 * delta, text)

    text = '- Horizontal scanning divergence of the system is currently 0.3° max'
    c.drawString(50, N - 18 * delta, text)

    text = '- System light output efficiency of at least 85%'
    c.drawString(50, N - 19 * delta, text)
    ...
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions"
                  r"\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\SetupData_up"
                  r"\AngleData_TX_Aper_5×2\InfoResponse\SystemOverview.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    c.drawImage(image, 50, 265, width=550, height=400)  # 调整位置和大小
    ...
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions"
                  r"\ZMX_System\03_DataInfo\30FOVSystem\SetupData_up\AngleData_TX_Aper_5×2\InfoResponse\系统扫描角度.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    ...
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\SetupData_up\AngleData_TX_Aper_5×2\InfoResponse\系统出射能效.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    ...
    # Input Image
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\SetupData_up\AngleData_TX_Aper_5×2\InfoResponse\水平方向发散角变化.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    c.drawImage(image, 100, 415, width=400, height=300)  # 调整位置和大小
    ...
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\SetupData_up\AngleData_TX_Aper_5×2\InfoResponse\垂直方向发散角变化.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    c.drawImage(image, 100, 50, width=400, height=300)  # 调整位置和大小
    ...
    # Input Image
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\SetupData_up\AngleData_TX_Aper_5×2\InfoResponse\系统扫描光斑.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    ...
    xls_path = (r'E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\SetupData_up\AngleData_TX_Aper_5×2\InfoResponse\SystemData.xlsx')
...
################################################################
    ...
    c.drawString(50, N - 0.5 * delta, 'Efficiency of OPA')

    # Input Image
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\EffectResponse\SysEffectInfo\RevAllRayInfo_ERDec.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    c.drawImage(image, 120, 395, width=400, height=300)  # 调整位置和大小


    c.setFont("Helvetica-Bold", 15)

    c.drawString(50, 355, 'Efficiency of SIPM')

    # Input Image
    image_path = (r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\EffectResponse\SysEffectInfo\RevAllRayInfo_ER.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    c.drawImage(image, 120, 15, width=400, height=300)  # 调整位置和大小
    ...
    c.drawString(50, N - 0.5 * delta, 'Efficiency of OPA to SiPM')

    # Input Image
    image_path = (
        r"E:\02_Solutions\Someones\PA\Engineering Implementation Solutions\Cone_Variant_Solutions\ZMX_System\03_DataInfo\30FOVSystem\EffectResponse\SysEffectInfo\Effect_OPAToSiPM.jpg")  # 替换为你的图片文件路径
    image = ImageReader(image_path)
    c.drawImage(image, 120, 395, width=400, height=300)  # 调整位置和大小
